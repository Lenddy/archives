				...
				<div className="content_container">
					<div className="profile_left">
						...
						<p>
							...
							{""}
							. This intensive four-month program pushed me to my
							limits as I strived to keep up with the fast-paced
							learning environment. Many nights were spent burning
							the midnight oil, often going to bed at 4 am and
							waking up at 11 am. Through laughter, tears, and
							forming strong friendships, I persevered, and it has
							paid off. I am now proud to call myself a full-stack
							developer.
							<br />
							<a href="https://www.codingdojo.com/">
								Coding Dojo
							...
							knowledge. My ultimate goal is to return to college
							one day and resume my computer engineering studies,
							with a possible focus on also becoming a game
							developer or even exploring carpentry.
							<br />
					...
					<div className="profile_right">all contact info here </div>
				</div>
			</div>
		</div>
	);
